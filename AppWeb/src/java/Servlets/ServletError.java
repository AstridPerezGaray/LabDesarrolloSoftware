...
public class ServletError extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Integer codigoEstado = (Integer)request.getAttribute("jakarta.servlet.error_code");
        String nombreServlet = (String)request.getAttribute("jakarta.servlet.error_name");
        String accionURL = (String)request.getAttribute("jakarta.servlet.error.request_url");
