...
INNER JOIN TipoEmpleado T ON T.ID_TipoEmpleado = EMPLE.ID_TipoEmpleado
INNER JOIN VistasDireccionCompleta DIR ON EMPLE.ID_Direccion = DIR.ID_Direccion;
...
CREATE VIEW VistaCompras AS
	...
	PRO.NombreProducto,
	P.ID_Proveedor,
	VPRO.NombreProveedor
FROM Compras AS C
INNER JOIN Pedidos P ON P.ID_Pedido = C.ID_Pedido
INNER JOIN Productos PRO ON PRO.ID_Producto = C.ID_Producto
INNER JOIN VistaProveedores VPRO ON VPRO.ID_Proveedor =P.ID_Proveedor;
